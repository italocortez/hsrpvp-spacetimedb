...
import HistoryLogRow from "./history_log_table";
import HistoryMetaRow from "./history_meta_table";
...
import MatchStepRow from "./match_step_table";
import SynergyCostRow from "./synergy_cost_table";
...
const tablesSchema = __schema({
  HistoryLog: __table({
    ...
    constraints: [
      { name: 'history_log_match_id_key', constraint: 'unique', columns: ['matchId'] },
    ],
  }, HistoryLogRow),
  HistoryMeta: __table({
    name: 'history_meta',
    ...
    constraints: [
      { name: 'history_meta_match_id_key', constraint: 'unique', columns: ['matchId'] },
    ],
  }, HistoryMetaRow),
  ...
  MatchParticipant: __table({
    ...
    constraints: [
      { name: 'match_participants_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, MatchParticipantRow),
  ...
  MatchStep: __table({
    ...
    constraints: [
      { name: 'match_step_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, MatchStepRow),
  SynergyCost: __table({
    name: 'synergy_cost',
    ...
    constraints: [
      { name: 'synergy_cost_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, SynergyCostRow),
  User: __table({
    name: 'user',
